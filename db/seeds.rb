...
# re1 = Review.new(comments: "good food", rating: 3, restaurant_id: r1.id, user_id: u4.id)
# re1.save!
# re2 = Review.new(comments: "yummy!", rating: 4, restaurant_id: r2.id, user_id: u5.id)
# re2.save!
# re3 = Review.new(comments: "delicious!", rating: 5, restaurant_id: r4.id, user_id: u5.id)
# re3.save!
